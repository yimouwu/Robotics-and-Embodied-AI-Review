...
## 3.3 Computer Vision - 计算机视觉<a id="Computer-Vision"></a>



## 3.4 Vision Language Model/Vision Language Action Model - 视觉-语言模型/视觉-语言-动作模型<a id="Vision-Language-Model/Vision-Language-Action"></a>
